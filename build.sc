...
object rocket extends mill.Cross[rocket]("2.12.13")

class rocket(val crossScalaVersion: String) extends CrossScalaModule with ScalafmtModule with PublishModule {
  ...
  def pomSettings = PomSettings(
    ...
    url = "https://www.github.com/chipsalliance/rocket",
