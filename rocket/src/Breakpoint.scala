...
class BreakpointUnit(n: Int, xLen: Int, useBPWatch: Boolean, vaddrBits: Int, mcontextWidth: Int, scontextWidth: Int) extends Module {
  val io = IO(new Bundle {
    val status = Input(new MStatus())
    val bp = Input(Vec(n, new BP(xLen, useBPWatch, vaddrBits, mcontextWidth, scontextWidth)))
